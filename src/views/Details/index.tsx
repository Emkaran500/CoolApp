...
import { IngredientKey, Meal, MeasureKey, Recipe } from "../../utils/types";
import { LoaderWrap } from "../../components/LoaderWrap";
import { styles } from "./styles";
import { RecipeList } from "./components/RecipeList";
import { makeHashtags } from "../../utils/helpers";
        ...
        <LoaderWrap isLoading={isLoading}>
            <ScrollView contentContainerStyle={styles.listContent} style={styles.list}>
                ...
                <View style={styles.headerInfo}>
                    ...
                    <Text style={styles.textTags} >{makeHashtags(details)}</Text>
                </View>
